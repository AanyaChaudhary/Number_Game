...
public class CurrencyConverter extends JFrame {
    ...
    public CurrencyConverter() {
        ...
        amountTextField.setBounds(80, 50, 100, 20);
    ...
    private void showThankYouMessage() {
        int option = JOptionPane.showOptionDialog(this, "Thank you u for using the Currency Converter!, Do you want to try again? ", 
        "Currency Converter", JOptionPane.YES_NO_OPTION, JOptionPane.INFORMATION_MESSAGE,null,new Object[]{"YES", "NO"},"Yes");
